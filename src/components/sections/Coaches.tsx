...
export default function Coaches() {
  ...
  return (
    <section
      ref={sectionRef}
      id="coaches"
      className="relative min-h-screen overflow-hidden bg-canvas md:min-h-[240vh]"
    >
    ...
    <div className="grid w-full grid-cols-1 gap-10 px-6 md:grid-cols-12 md:gap-12 md:px-12">
      ...
      >
        ...
        <motion.p
          ...
          transition={{ duration: 0.8, delay: reducedMotion ? 0 : 0.4 }}
        >
          {data.bio}
        </motion.p>
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-6">
          {data.stats.map((stat, i) => (
            <motion.div
              ...
              transition={{
                duration: 0.7,
                delay: reducedMotion ? 0 : 0.8 + i * 0.1,
              }}
            >
